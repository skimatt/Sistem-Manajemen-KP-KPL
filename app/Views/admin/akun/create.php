...
<div class="space-y-6 max-w-2xl mx-auto">
    ...
    <div class="flex items-center gap-3">
        ...
        <div>
            <h1 class="text-xl font-bold text-slate-800 dark:text-slate-100">Tambah Akun Pengguna</h1>
            <p class="text-xs text-slate-500 dark:text-slate-400 mt-0.5">Buat akun pengguna baru dengan menetapkan peranan (role) tertentu.</p>
        </div>
    </div>
    ...
    <div class="bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-800 rounded-xl p-6 shadow-sm">
        <form action="<?= base_url('admin/akun/store') ?>" method="POST" class="space-y-5">
            <?= csrf_field() ?>
                ...
                <div class="grid grid-cols-1 sm:grid-cols-2 gap-4">
                    ...
                    <div>
                        ...
                        <select name="role" 
                            ...
                            <option value="instansi" <?= old('role') === 'instansi' ? 'selected' : '' ?>>Instansi Mitra</option>
                        </select>
                    </div>
