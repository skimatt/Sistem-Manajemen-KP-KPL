...
<div class="space-y-6 max-w-2xl mx-auto">
    ...
    <div class="flex items-center gap-3">
        ...
        <div>
            <h1 class="text-xl font-bold text-slate-800 dark:text-slate-100">Tambah Program Studi</h1>
            <p class="text-xs text-slate-500 dark:text-slate-400 mt-0.5">Tambahkan program studi baru dan konfigurasikan tipe penugasan magang.</p>
        </div>
    </div>
    ...
    <div class="bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-800 rounded-xl p-6 shadow-sm">
        <form action="<?= base_url('admin/prodi/store') ?>" method="POST" class="space-y-5">
            <?= csrf_field() ?>
            ...
            <div>
                ...
                <div class="grid grid-cols-1 sm:grid-cols-2 gap-4">
                    ...
                    <div>
                        ...
                        <input type="text" 
                               name="faculty" 
                               value="<?= old('faculty', 'Fakultas Ilmu Komputer') ?>" 
                    ...
                    <div>
                        ...
                        <select name="kp_label" 
                            ...
                            <option value="KP" <?= old('kp_label') === 'KP' ? 'selected' : '' ?>>KP (Kerja Praktek)</option>
                            <option value="KPL" <?= old('kp_label') === 'KPL' ? 'selected' : '' ?>>KPL (Kerja Praktek Lapangan)</option>
                        </select>
                    </div>
